...
library(plotly)
library(DT)
ozona_hr <- readRDS("data/hourly_outside_zona_final_Fri_Feb_04.rds")
ozona <- readRDS("data/hourly_outside_zona_final_Fri_Feb_04.rds")
izona_hr <- readRDS("data/instant_inside_zona_final_Fri_Feb_04.rds")
izona <- readRDS("data/instant_inside_zona_final_Fri_Feb_04.rds")
oestrella_hr <- readRDS("data/hourly_outside_estrella_final_Fri_Feb_04.rds")
oestrella <- readRDS("data/hourly_outside_estrella_final_Fri_Feb_04.rds")
iestrella_hr <- readRDS("data/instant_inside_estrella_final_Fri_Feb_04.rds")
iestrella <- readRDS("data/instant_inside_estrella_final_Fri_Feb_04.rds")
# User interface ----
ui <-
