                      ...
                      fluidRow(
                        column(
                         ...
                         have four devices installed in Torreon, Mexico. The interactive plots and tables provided show
                          ...
                          p("Please note that this is",strong("raw data."),"We aim to update these plots weekly.",style="text-align:center;color:black;background-color:light blue;padding:15px;border-radius:10px;font-size:20px"),
                          br(),
                          br(),
