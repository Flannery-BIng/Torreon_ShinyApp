...
library(plotly)
library(DT)
ozona_hr <- readRDS("data/hourly_outside_zona2Thu_Mar_03.rds")
ozona <- readRDS("data/instant_outside_zona2Thu_Mar_03.rds")
izona_hr <- readRDS("data/hourly_inside_zona2Thu_Mar_03.rds")
izona <- readRDS("data/instant_inside_zona2Thu_Mar_03.rds")
oestrella_hr <- readRDS("data/hourly_outside_estrella2Thu_Mar_03.rds")
oestrella <- readRDS("data/instant_outside_estrella2Thu_Mar_03.rds")
iestrella_hr <- readRDS("data/hourly_inside_estrella2Thu_Mar_03.rds")
iestrella <- readRDS("data/instant_inside_estrella2Thu_Mar_03.rds")
