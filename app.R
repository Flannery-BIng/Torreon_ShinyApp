...
library(plotly)
library(DT)
ozona_hr <- readRDS("data/hourly_outside_zona_finalMon_Feb_07.rds")
ozona <- readRDS("data/instant_outside_zona_finalMon_Feb_07.rds")
izona_hr <- readRDS("data/hourly_inside_zona_finalMon_Feb_07.rds")
izona <- readRDS("data/instant_inside_zona_finalMon_Feb_07.rds")
oestrella_hr <- readRDS("data/hourly_outside_estrella_finalMon_Feb_07.rds")
oestrella <- readRDS("data/instant_outside_estrella_finalMon_Feb_07.rds")
iestrella_hr <- readRDS("data/hourly_inside_estrella_finalMon_Feb_07.rds")
iestrella <- readRDS("data/instant_inside_estrella_finalMon_Feb_07.rds")
# User interface ----
ui <-
