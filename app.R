...
library(plotly)
library(DT)
ozona_hr <- readRDS("data/hourly_outside_zona2Wed_Feb_16.rds")
ozona <- readRDS("data/instant_outside_zona2Wed_Feb_16.rds")
izona_hr <- readRDS("data/hourly_inside_zona2Wed_Feb_16.rds")
izona <- readRDS("data/instant_inside_zona2Wed_Feb_16.rds")
oestrella_hr <- readRDS("data/hourly_outside_estrella2Wed_Feb_16.rds")
oestrella <- readRDS("data/instant_outside_estrella2Wed_Feb_16.rds")
iestrella_hr <- readRDS("data/hourly_inside_estrella2Wed_Feb_16.rds")
iestrella <- readRDS("data/instant_inside_estrella2Wed_Feb_16.rds")
