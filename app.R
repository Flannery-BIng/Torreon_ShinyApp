...
ozona <- readRDS("data/instant_outside_zona_finalFri_Feb_04.rds")
izona_hr <- readRDS("data/hourly_inside_zona_finalFri_Feb_04.rds")
...
oestrella <- readRDS("data/instant_outside_estrella_finalFri_Feb_04.rds")
iestrella_hr <- readRDS("data/hourly_inside_estrella_finalFri_Feb_04.rds")
