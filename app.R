...
library(plotly)
library(DT)
ozona_hr <- readRDS("data/hourly_outside_zona2Fri_Mar_18.rds")
ozona <- readRDS("data/instant_outside_zona2Fri_Mar_18.rds")
izona_hr <- readRDS("data/hourly_inside_zona2Fri_Mar_18.rds")
izona <- readRDS("data/instant_inside_zona2Fri_Mar_18.rds")
oestrella_hr <- readRDS("data/hourly_outside_estrella2Fri_Mar_18.rds")
oestrella <- readRDS("data/instant_outside_estrella2Fri_Mar_18.rds")
iestrella_hr <- readRDS("data/hourly_inside_estrella2Fri_Mar_18.rds")
iestrella <- readRDS("data/instant_inside_estrella2Fri_Mar_18.rds")
